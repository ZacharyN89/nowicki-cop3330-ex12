...
public class ex12 {
    public static void main(String[] args){
        ...
        int p = Integer.parseInt(cursor.nextLine());

        System.out.print("Enter the rate of interest: ");
        double r = Double.parseDouble(cursor.nextLine());
        double rate = r/100;

        System.out.print("Enter the number of years: ");
        int t = Integer.parseInt(cursor.nextLine());

        double investment = p * (1 + rate * t);
        investment = Math.round(investment * 100.0) / 100.0;
        System.out.println("After " + t + " years at " + r + "%, the investment will be worth $" + investment + ".");
    }
}
